...
$sql="update tbluser set fname=:fname,age=:age,weight=:weight,mobile=:mobile,city=:city,state=:state,address=:Address where id=:uid";
				...
				<div class="col-lg-8">
					<form class="singup-form contact-form" method="post">
						<div class="row">
							<?php 
							$uid=$_SESSION['uid'];
							$sql ="SELECT id, fname, age, email,weight, mobile, password, address,state,city, create_date from tbluser where id=:uid ";
							$query= $dbh -> prepare($sql);
							$query->bindParam(':uid',$uid, PDO::PARAM_STR);
							$query-> execute();
							...
							<div class="col-md-6">
								<input type="text" name="age" id="age" placeholder="Enter Age" autocomplete="off" value="<?php echo $result->age;?>">
							</div>
							<div class="col-md-6">
								<input type="text" name="email" id="email" placeholder="Your Email" autocomplete="off" value="<?php echo $result->email;?>" readonly>
							</div>
							<div class="col-md-6">
								<input type="text" name="weight" id="weight" placeholder="Enter Weight" autocomplete="off" value="<?php echo $result->weight;?>">
							</div>
							<div class="col-md-6">
