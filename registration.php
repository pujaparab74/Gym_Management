...
$sql="INSERT INTO tbluser (fname,age,email,mobile,state,city,weight,address,password) Values(:fname,:age,:email,:mobile,:state,:city,:weight,:address,:Password)";
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<form class="singup-form contact-form" method="post">
						<div class="row">
							<div class="col-md-6">
								<input type="text" name="fname" id="fname" placeholder="Enter Full Name" autocomplete="off" value="<?php echo $fname;?>" required>
							</div>
							<div class="col-md-6">
								<input type="text" name="age" id="age" placeholder="Enter Age" autocomplete="off" value="<?php echo $age;?>" required>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<input type="text" name="weight" id="weight" placeholder="Enter Weight" autocomplete="off" value="<?php echo $weight;?>" required>
							</div>
							<div class="col-md-6">
