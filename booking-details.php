...
t2.Price as Price,t2.type as type,t2.Description as Description,t4.category_name as category_name,t5.PackageName as PackageName,payment,paymentType FROM tblbooking as t1
...
on t2.PackageType=t5.id
 where t1.id=:bookindid";
                  ...
                  <th>Trainer Type</th>
                   <td colspan="3"><?php echo $result->type; ?></td>
...
<tr>
  <th>Reamaning Payment</th>
  <th><?php
  $rpayment=$pricess-$gpayment;
