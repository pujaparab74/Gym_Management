...
$titlename = $_POST['titlename'];$package = $_POST['package'];$packageduratiobn = $_POST['packageduratiobn'];$Price = $_POST['Price'];$photo = $_POST['photo'];$type=$_POST['type'];$description = $_POST['description'];

$sql="INSERT INTO tbladdpackage (category,titlename,PackageType,PackageDuratiobn,Price,type,Description) 
Values(:category,:titlename,:package,:packageduratiobn,:Price,:type,:description)";
              ...
              <form class="row" method="post">
                ...
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="type" id="type" placeholder="Enter Trainer Type">
                </div> 
