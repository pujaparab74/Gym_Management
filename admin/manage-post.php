...
echo "<script>window.location.href='manage-post.php'</script>";
                ...
                <tbody>
                  ...
                  <td>
                   ...
                   <a href="edit-post.php?pid=<?php echo htmlentities($result->packageid);?>"><span class="btn btn-success">Edit</span>
                  
                   
                   <a href="manage-post.php?del=<?php echo htmlentities($result->id);?>"><span class="btn btn-danger" >Delete</span></td>
                  </tr>
