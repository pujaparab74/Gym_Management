...
<html lang="en">
  ...
  <div class="col-md-6 col-lg-6">
        ...
        <div class="col-md-6 col-lg-6">
          <?php
                  $sql="SELECT count(id) as equipments FROM equipment;";
                  $query= $dbh->prepare($sql);
                  $query-> execute();
                  $results = $query -> fetchAll(PDO::FETCH_OBJ);
                  $cnt=1;
          ...
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-file fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $result->equipments;?></b></p>
            </div>
          </div>
        </a>
            <?php  $cnt=$cnt+1; } } ?>
        ...
        <div class="col-md-6 col-lg-6">
          <?php
                  $sql="SELECT count(id) as trainers FROM trainer;";
                  $query= $dbh->prepare($sql);
                  $query-> execute();
                  $results = $query -> fetchAll(PDO::FETCH_OBJ);
                  foreach($results as $result)
                  {
                  ?>
                  <a href="manage-trainer.php"> 
          <div class="widget-small info coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4>Total Trainer</h4>
              <p><b><?php echo $result->trainers;?></b></p>
            </div>
          </div>
        </a>
            <?php  } ?>
