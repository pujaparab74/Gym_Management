...
packageduratiobn=:packageduratiobn,Price=:Price,type=:type,description=:description where id=:pid";
            ...
            <div class="tile-body">
              <form class="row" method="post">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" type="text" name="type" id="type" placeholder="Enter Trainer Type" value="<?php echo $result->type;?>">
                </div> 
